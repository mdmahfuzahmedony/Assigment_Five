...
//     coines_main_value = coines_main_value - 20;
...
//     text.innerHTML = `<p class="font-bold">${service_names}</p><p class="text-xs text-gray-600">${service_numbers}</p>`;

//     left_side.appendChild(text);
...
//     item.appendChild(left_side);
//     item.appendChild(timetext);
//     clearHistory.prepend(item);
//   });
//   const clearBtn = document.getElementById("history-list");
